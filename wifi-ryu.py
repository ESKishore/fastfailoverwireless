...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def add_flow(self, dp, p, match, actions, idle_timeout=0, hard_timeout=0,buffer_id=''):
        ofproto = dp.ofproto
    ...
    def build_flow(self, msg,priority, flow_info, src_port, out_port, out_port2):
        ...
        self.add_flow(datapath, priority, match, actions,idle_timeout=60,hard_timeout=60,buffer_id=NO_BUFFER)
        
        out = datapath.ofproto_parser.OFPPacketOut(datapath=datapath, buffer_id=NO_BUFFER, data=msg.data, in_port=src_port, actions=actions)
        #try:
        datapath.send_msg(out)
        #except:
